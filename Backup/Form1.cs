...
namespace AngelBot
{
    public partial class Form1 : Form
    {
        ...
        public void timer1_Tick(object sender, EventArgs e) //200ms refresh
        {
            ...
            if (tar.IsDead && tarLastKillID != tarID)
            {
                kills += 1;
                tarLastKillID = tarID;
                tarID = 0;
            ...
            healthbar.Value = (int)pc.Health;
            healthbar.CreateGraphics().DrawString(pc.Health + "/" + pc.MaxHealth, new Font("Arial", (float)8.25, FontStyle.Bold), Brushes.WhiteSmoke, new PointF(healthbar.Width / 2 - 30, healthbar.Height / 2 - 7));
            manabar.Maximum = pc.MaxMP;
            manabar.Value = (int)pc.MP;
            manabar.CreateGraphics().DrawString(pc.MP + "/" + pc.MaxMP, new Font("Arial", (float)8.25, FontStyle.Bold), Brushes.WhiteSmoke, new PointF(manabar.Width / 2 - 30, manabar.Height / 2 - 7));
            displayrange();
