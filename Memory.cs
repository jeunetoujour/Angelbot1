...
namespace MemoryLib
{
    public class Memory
    {
        ...
        #region ReadMemory
        public bool ReadMemory(int index, uint Address, ref byte[] buffer, int size)
        {
            return ReadMemory(procs[index].pHandle, Address, ref buffer, size);
        }

        public bool ReadMemory(int index, uint Address, ref byte[] buffer)
        {
            return ReadMemory(procs[index].pHandle, Address, ref buffer);
        }

        public double ReadDouble(int index, uint Address, bool reverse)
        {
        ...
        public double ReadDouble(int index, uint Address)
        { return ReadDouble(index, Address, false); }

        public float ReadFloat(int index, uint Address, bool reverse)
        {
        ...
        public float ReadFloat(int index, uint Address)
        { return ReadFloat(index, Address, false); }

        public UInt64 ReadUInt64(int index, uint Address, bool reverse)
        {
        ...
        public UInt64 ReadUInt64(int index, uint Address)
        { return ReadUInt64(index, Address, false); }

        public Int64 ReadInt64(int index, uint Address, bool reverse)
        {
        ...
        public Int64 ReadInt64(int index, uint Address)
        { return ReadInt64(index, Address, false); }

        public uint ReadUInt(int index, uint Address, bool reverse)
        {
        ...
        public uint ReadUInt(int index, uint Address) { return ReadUInt(index, Address, false); }

        public int ReadInt(int index, uint Address, bool reverse)
        {
            byte[] buffer = new byte[4];
            if (!ReadMemory(index, Address, ref buffer))
            {
        ...
        public int ReadInt(int index, uint Address) { return ReadInt(index, Address, false); }

        public ushort ReadUShort(int index, uint Address, bool reverse)
        {
        ...
        public ushort ReadUShort(int index, uint Address) { return ReadUShort(index, Address, false); }

        public short ReadShort(int index, uint Address, bool reverse)
        {
            byte[] buffer = new byte[2];
            if (!ReadMemory(index, Address, ref buffer))
            {
        ...
        public short ReadShort(int index, uint Address) { return ReadShort(index, Address, false); }

        public byte ReadByte(int index, uint Address)
        {
        ...
        public sbyte ReadSByte(int index, uint Address)
        {
            byte[] buffer = new byte[1];
            if (!ReadMemory(index, Address, ref buffer))
            {
        ...
        public string ReadString(int index, uint Address, int length)
        {
        ...
        public string ReadString(int index, uint Address, int length, Encoding encoding)
        {
            byte[] buffer = new byte[length];
        ...
        public static IntPtr OpenProcess(int dwProcessId)
        {
            ...
            IntPtr test = OpenProcess(PROCESS_ALL_ACCESS, false, dwProcessId);
            return OpenProcess(PROCESS_ALL_ACCESS, false, dwProcessId);
        }
        ...
        public static bool ReadMemory(IntPtr pHandle, uint Address, ref byte[] buffer, int size)
        {
            return ReadProcessMemory(pHandle, (UIntPtr)Address, buffer, (UIntPtr)size, IntPtr.Zero);
        }

        public static bool ReadMemory(IntPtr pHandle, uint Address, ref byte[] buffer)
        {
            return ReadProcessMemory(pHandle, (UIntPtr)Address, buffer, (UIntPtr)buffer.Length, IntPtr.Zero);
        }

        public static double ReadDouble(IntPtr pHandle, uint Address, bool reverse)
        {
            byte[] buffer = new byte[sizeof(double)];
        ...
        public static double ReadDouble(IntPtr pHandle, uint Address)
        { return ReadDouble(pHandle, Address, false); }

        public static float ReadFloat(IntPtr pHandle, uint Address, bool reverse)
        {
            byte[] buffer = new byte[sizeof(float)];
        ...
        public static float ReadFloat(IntPtr pHandle, uint Address)
        { return ReadFloat(pHandle, Address, false); }

        public static UInt64 ReadUInt64(IntPtr pHandle, uint Address, bool reverse)
        {
            byte[] buffer = new byte[sizeof(UInt64)];
            if (ReadMemory(pHandle, Address, ref buffer, 8))
            {
        ...
        public static UInt64 ReadUInt64(IntPtr pHandle, uint Address)
        { return ReadUInt64(pHandle, Address, false); }

        public static Int64 ReadInt64(IntPtr pHandle, uint Address, bool reverse)
        {
            byte[] buffer = new byte[sizeof(Int64)];
            if (ReadMemory(pHandle, Address, ref buffer, 8))
            {
        ...
        public static Int64 ReadInt64(IntPtr pHandle, uint Address)
        { return ReadInt64(pHandle, Address, false); }

        public static uint ReadUInt(IntPtr pHandle, uint Address, bool reverse)
        {
        ...
        public static uint ReadUInt(IntPtr pHandle, uint Address)
        { return ReadUInt(pHandle, Address, false); }

        public static int ReadInt(IntPtr pHandle, uint Address, bool reverse)
        {
        ...
        public static int ReadInt(IntPtr pHandle, uint Address)
        { return ReadInt(pHandle, Address, false); }

        public static ushort ReadUShort(IntPtr pHandle, uint Address, bool reverse)
        {
        ...
        public static ushort ReadUShort(IntPtr pHandle, uint Address)
        { return ReadUShort(pHandle, Address, false); }

        public static short ReadShort(IntPtr pHandle, uint Address, bool reverse)
        {
        ...
        public static short ReadShort(IntPtr pHandle, uint Address)
        { return ReadShort(pHandle, Address, false); }

        public static byte ReadByte(IntPtr pHandle, uint Address)
        {
        ...
        public static sbyte ReadSByte(IntPtr pHandle, uint Address)
        {
        ...
        public static string ReadString(IntPtr pHandle, uint Address, int length)
        {
            byte[] buffer = new byte[length];
        ...
        public static string ReadString(IntPtr pHandle, uint Address, int length, bool IsUnicode)
        {
            byte[] buffer = new byte[length];
            ReadMemory(pHandle, Address, ref buffer);
            string ret;
        ...
        public static string ReadWStdString(IntPtr pHandle, uint Address)
        {
            Address += 0x4;

            int length = ReadInt(pHandle, Address + (uint)0x14);

            if (length > 8)
            {
                // length needed is in bytes, not chars - 2 bytes per char. :)
                return ReadString(pHandle, Memory.ReadUInt(pHandle, Address), length * 2, true);
            }
            else
            {
        ...
        public static bool WriteMemory(IntPtr pHandle, uint Address, string value, bool isUnicode)
        {
            byte[] buffer;
            if (!isUnicode)
            {
                 buffer = ASCIIEncoding.UTF8.GetBytes(value);
            }
            else
            {

                buffer = ASCIIEncoding.Unicode.GetBytes(value);

            }
            return WriteMemory(pHandle, Address, buffer);
        }

        public static bool WriteMemory(IntPtr pHandle, uint Address, UInt64 value)
        {
            byte[] buffer = BitConverter.GetBytes(value);
            return WriteMemory(pHandle, Address, buffer);
        }

        public static bool WriteMemory(IntPtr pHandle, uint Address, Int64 value)
        {
            byte[] buffer = BitConverter.GetBytes(value);
            return WriteMemory(pHandle, Address, buffer);
        }

        public static bool WriteMemory(IntPtr pHandle, uint Address, double value)
        {
            byte[] buffer = BitConverter.GetBytes(value);
            return WriteMemory(pHandle, Address, buffer);
        }

        public static bool WriteMemory(IntPtr pHandle, uint Address, float value)
        {
            byte[] buffer = BitConverter.GetBytes(value);
            return WriteMemory(pHandle, Address, buffer);
        }

        public static bool WriteMemory(IntPtr pHandle, uint Address, sbyte value)
        {
            byte[] buffer = BitConverter.GetBytes(value);
            return WriteMemory(pHandle, Address, buffer, 1);
        }

        public static bool WriteMemory(IntPtr pHandle, uint Address, byte value)
        {
            byte[] buffer = BitConverter.GetBytes(value);
            return WriteMemory(pHandle, Address, buffer, 1);
        }

        public static bool WriteMemory(IntPtr pHandle, uint Address, short value)
        {
            byte[] buffer = BitConverter.GetBytes(value);
            return WriteMemory(pHandle, Address, buffer, 2);
        }

        public static bool WriteMemory(IntPtr pHandle, uint Address, ushort value)
        {
            byte[] buffer = BitConverter.GetBytes(value);
            return WriteMemory(pHandle, Address, buffer, 2);
        }

        public static bool WriteMemory(IntPtr pHandle, uint Address, int value)
        {
            byte[] buffer = BitConverter.GetBytes(value);
            return WriteMemory(pHandle, Address, buffer, 4);
        }

        public static bool WriteMemory(IntPtr pHandle, uint Address, uint value)
        {
            byte[] buffer = BitConverter.GetBytes(value);
            return WriteMemory(pHandle, Address, buffer, 4);
        }

        public static bool WriteMemory(IntPtr pHandle, uint Address, byte[] buffer, int size)
        {
            return WriteProcessMemory(pHandle, (UIntPtr)Address, buffer, (UIntPtr)size, IntPtr.Zero);
        }

        public static bool WriteMemory(IntPtr pHandle, uint Address, byte[] buffer)
        {
        ...
        public static uint InjectDll(IntPtr pHandle, string dllname)
        {
            ...
            WriteMemory(pHandle, pLibModule, dllname, false);
        ...
        public static uint GetProcAddressEx(IntPtr pHandle, string modulename, string procname)
        {
            ...
            WriteMemory(pHandle, codecave + 0x300, modulename, false);
            ...
            WriteMemory(pHandle, codecave + 0x600, procname,false);
